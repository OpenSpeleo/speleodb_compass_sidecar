...
The Edit submenu is the app-wide source of desktop clipboard accelerators: Cut,
Copy, Paste, and Select All. It is present both before and after authentication
so fields such as the OAuth token input keep normal Cmd/Ctrl+V paste behavior.
